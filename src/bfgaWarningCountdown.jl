...
module bfgaWarningCountdown
    ...
    function getParams()
        ...
        return Main.SSA.Types.GAParams(100, 10000 , 150, 150, 0.7, 0.01, true, logfile ,  0.0 , tgFitness, 0.0 , 0 )
    end
...
function test_serial()
    model = SSA.runssa(bfga, bfgaWarningCountdown) #, initial_pop_size = 156)
    model
end
