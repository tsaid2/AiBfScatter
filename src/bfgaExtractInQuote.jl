...
module bfgaExtractInQuote
    ...
    function getParams()
        ...
        return Main.SSA.Types.GAParams(100, 100000 , 120, 150, 0.7, 0.01, true, logfile ,  0.0 , tgFitness, 0.0 , 0 )
    end
...
function test_serial()
    model = SSA.runssa(bfga, bfgaExtractInQuote) #, initial_pop_size = 156)
    model
end
